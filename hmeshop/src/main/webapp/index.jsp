...
<div class="container">
  ...
  <img src="<%=request.getContextPath()%>/Resources/LOGO1.jpg"  class=img-rounded alt="LOGO1" width="300" height="150">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div><img src="<%=request.getContextPath()%>/Resources/chimney.jpg" height="300px" width="800px"></div>
            </div>
            <div class="item">
             <div><img src="<%=request.getContextPath()%>/Resources/cooker.jpg" height="300px" width="800px"></div>
       
            </div>
            <div class="item">
                <div><img src="<%=request.getContextPath()%>/Resources/f w.jpg" height="300px" width="800px"></div>    
            </div>
             <div class="item">
                <div><img src="<%=request.getContextPath()%>/Resources/rice cooker.jpg" height="300px" width="800px"></div>    
            </div>
             <div class="item">
                <div><img src="<%=request.getContextPath()%>/Resources/sofa.jpg" height="300px" width="800px"></div>    
            </div>
        </div>
        <!-- Carousel controls -->
